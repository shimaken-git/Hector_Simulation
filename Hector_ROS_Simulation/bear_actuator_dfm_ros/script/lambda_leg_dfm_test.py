...
def leg_control():
    ...
    rospy.Subscriber("/lambda_leg/L_hip_controller/state", MotorState, motorState1Cb)
    rospy.Subscriber("/lambda_leg/R_hip_controller/state", MotorState, motorState2Cb)
