...
void timerCallback(bear_actuator_dfm_ros::HardwareInterface &hardware_interface,
...
int main(int argc, char **argv)
{
  ...
  bear_actuator_dfm_ros::HardwareInterface hardware_interface(node_handle, priv_node_handle);
