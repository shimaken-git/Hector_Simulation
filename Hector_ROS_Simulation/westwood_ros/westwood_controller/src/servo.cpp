...
#include "westwood_legged_msgs/LowState.h"
...
using namespace std;
using namespace westwood_model;
...
public:
    ...
    void FRhipCallback(const westwood_legged_msgs::MotorState& msg)
    {
        start_up = false;
    ...
    void FRthighCallback(const westwood_legged_msgs::MotorState& msg)
    {
    ...
    void FRcalfCallback(const westwood_legged_msgs::MotorState& msg)
    {
    ...
    void FLhipCallback(const westwood_legged_msgs::MotorState& msg)
    {
        start_up = false;
    ...
    void FLthighCallback(const westwood_legged_msgs::MotorState& msg)
    {
    ...
    void FLcalfCallback(const westwood_legged_msgs::MotorState& msg)
    {
    ...
    void RRhipCallback(const westwood_legged_msgs::MotorState& msg)
    {
        start_up = false;
    ...
    void RRthighCallback(const westwood_legged_msgs::MotorState& msg)
    {
    ...
    void RRcalfCallback(const westwood_legged_msgs::MotorState& msg)
    {
    ...
    void RLhipCallback(const westwood_legged_msgs::MotorState& msg)
    {
        start_up = false;
    ...
    void RLthighCallback(const westwood_legged_msgs::MotorState& msg)
    {
    ...
    void RLcalfCallback(const westwood_legged_msgs::MotorState& msg)
    {
...
{
    ros::init(argc, argv, "westwood_gazebo_servo");
    ...
    lowState_pub = n.advertise<westwood_legged_msgs::LowState>("/" + robot_name + "_gazebo/lowState/state", 1);
    servo_pub[0] = n.advertise<westwood_legged_msgs::MotorCmd>("/" + robot_name + "_gazebo/FR_hip_controller/command", 1);
    servo_pub[1] = n.advertise<westwood_legged_msgs::MotorCmd>("/" + robot_name + "_gazebo/FR_thigh_controller/command", 1);
    servo_pub[2] = n.advertise<westwood_legged_msgs::MotorCmd>("/" + robot_name + "_gazebo/FR_calf_controller/command", 1);
    servo_pub[3] = n.advertise<westwood_legged_msgs::MotorCmd>("/" + robot_name + "_gazebo/FL_hip_controller/command", 1);
    servo_pub[4] = n.advertise<westwood_legged_msgs::MotorCmd>("/" + robot_name + "_gazebo/FL_thigh_controller/command", 1);
    servo_pub[5] = n.advertise<westwood_legged_msgs::MotorCmd>("/" + robot_name + "_gazebo/FL_calf_controller/command", 1);
    servo_pub[6] = n.advertise<westwood_legged_msgs::MotorCmd>("/" + robot_name + "_gazebo/RR_hip_controller/command", 1);
    servo_pub[7] = n.advertise<westwood_legged_msgs::MotorCmd>("/" + robot_name + "_gazebo/RR_thigh_controller/command", 1);
    servo_pub[8] = n.advertise<westwood_legged_msgs::MotorCmd>("/" + robot_name + "_gazebo/RR_calf_controller/command", 1);
    servo_pub[9] = n.advertise<westwood_legged_msgs::MotorCmd>("/" + robot_name + "_gazebo/RL_hip_controller/command", 1);
    servo_pub[10] = n.advertise<westwood_legged_msgs::MotorCmd>("/" + robot_name + "_gazebo/RL_thigh_controller/command", 1);
    servo_pub[11] = n.advertise<westwood_legged_msgs::MotorCmd>("/" + robot_name + "_gazebo/RL_calf_controller/command", 1);
