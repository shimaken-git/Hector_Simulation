...
namespace gazebo
{
    class WestwoodFootContactPlugin : public SensorPlugin
    {
        public:
        WestwoodFootContactPlugin() : SensorPlugin(){}
        ~WestwoodFootContactPlugin(){}
        ...
        void Load(sensors::SensorPtr _sensor, sdf::ElementPtr _sdf)
        {
            ...
            if (!this->parentSensor){
                gzerr << "WestwoodFootContactPlugin requires a ContactSensor.\n";
                return;
            }
            ...
            this->update_connection = this->parentSensor->ConnectUpdated(std::bind(&WestwoodFootContactPlugin::OnUpdate, this));
    ...
    GZ_REGISTER_SENSOR_PLUGIN(WestwoodFootContactPlugin)
}
