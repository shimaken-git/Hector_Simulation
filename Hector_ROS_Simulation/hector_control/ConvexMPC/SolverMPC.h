...
void leg_Jv(Matrix<fpt, 3, 3> R, double q0,  double q1, double q2, double q3, double q4,int leg);
void leg_Jw(Matrix<fpt, 3, 3> R, double q0,  double q1, double q2, double q3, double q4,int leg);
mfp* get_q_soln();
#endif
